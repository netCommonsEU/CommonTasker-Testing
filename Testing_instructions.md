...
CommonTasker is a mobile crowdsourcing application developed for the purposes of the project netcommons in the context of Community Networks. The current version of the application uses an online platform (Firebase) for handling its database. Checking the UI and the design
